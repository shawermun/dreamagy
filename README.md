...
Если Эллиот не по душе, можно поставить любого персонажа:
- **Статичная картинка**: положите PNG, JPG или WebP файл в папку `assets/pets/` и выберите его через правый клик -> "Сменить питомца".
- **Живая анимация**: создайте папку внутри `assets/pets/` (например `assets/pets/my_character/`), закиньте туда пронумерованные кадры (`frame_000.png`, `frame_001.png`, ...) и программа подхватит их как видео-последовательность.
- Масштаб, режим отстыковки и все эффекты работают одинаково для любого питомца.
